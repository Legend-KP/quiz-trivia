 ...
 * Verified: ✅ Yes
 * 
 * ABI Source: Verified contract on BaseScan (includes game sync functions)
 * Last Updated: Contract verification complete
 */
...
export function getBetModeVaultAddress(): `0x${string}` {
  const address =
    ...
    '0xc6046a1a08C7DD17832C561d5ecb366d85b1FC8E'; // New contract address with new QT token
