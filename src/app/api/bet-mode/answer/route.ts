          ...
          (async () => {
            try {
              ...
              if (lossDistribution.toPlatform > 0) {
                ...
                console.log(`💰 Owner wallet balance before transfer: ${ethers.formatEther(ownerBalance)} QT`);
                
                // Immediately transfer to revenue wallet
                console.log(`💸 Transferring ${lossDistribution.toPlatform} QT (${revenueAmountWei.toString()} wei) to revenue wallet ${REVENUE_WALLET}...`);
                ...
                console.log(`✅ Successfully sent ${lossDistribution.toPlatform} QT to revenue wallet ${REVENUE_WALLET}`);
                console.log(`🔗 View on BaseScan: https://basescan.org/tx/${revenueTx.hash}`);
                ...
                console.log(`✅ Revenue wallet balance after transfer: ${ethers.formatEther(revenueWalletBalance)} QT`);
              }
            } catch (error: any) {
