...
const TIME_MODE_FALLBACK_QUESTIONS: QuizQuestion[] = [
  ...
  { id: 1032, question: 'Key limitation of Bitcoin Script vs Ethereum?', options: ['No native tokens','Limited Turing-completeness','Cannot process transactions','No cryptographic signatures'], correct: 1, timeLimit: 45, explanation: 'Bitcoin Script is intentionally non-Turing-complete for security.' },
  { id: 1033, question: 'Bitcoin feature enabling time-based smart contracts?', options: ['SegWit','CheckLockTimeVerify (CLTV)','Taproot','Ordinals'], correct: 1, timeLimit: 45, explanation: 'CLTV (BIP-65) locks transactions until specific future time/block.' },
  ...
  { id: 1035, question: 'Layer-2 solution for complex Bitcoin smart contracts?', options: ['Polygon','Lightning Network','Arbitrum','Optimism'], correct: 1, timeLimit: 45, explanation: 'Lightning Network enables off-chain smart contracts with Bitcoin settlement.' },
  { id: 1036, question: 'Role of Hashed Timelock Contracts (HTLCs)?', options: ['Enable cross-chain atomic swaps and payment channels','Replace all on-chain transactions','Eliminate private keys','Enforce centralized custody'], correct: 1, timeLimit: 45, explanation: 'HTLCs enable trustless conditional transfers in Lightning and atomic swaps.' },
  { id: 1037, question: 'How does BRC-2.0 enhance Bitcoin smart contracts?', options: ['Replace Script with Turing-complete language','Standardize tokenization and DeFi on Bitcoin','Limit to Layer-2 only','Require centralized oracles'], correct: 1, timeLimit: 45, explanation: 'BRC-2.0 standardizes token creation and basic DeFi contracts on Bitcoin.' },
